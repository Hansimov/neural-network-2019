# 条件生成式对抗网络(CGAN)代码及结果解析
#   https://blog.csdn.net/qq_21210467/article/details/82077862
#   https://github.com/MrRenQIANG/GANs/blob/master/my_cgan_tensorflow.py
...
batch_size = 64
X_dim = 784  # image dimension
y_dim = 10   # label dimension
